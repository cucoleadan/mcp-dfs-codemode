/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker/worker-configuration.d.ts` (hash: 73377f5a0118ddddcaaf2f2bfa49e540)
// Runtime types generated with workerd@1.20260518.1 2025-07-05 nodejs_compat
interface __BaseEnv_Env {
	CRED_CONFIG: KVNamespace;
	LOADER: WorkerLoader;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../build/worker/worker/index-worker-codemode");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLED_MODULES" | "DATAFORSEO_FULL_RESPONSE" | "DATAFORSEO_SIMPLE_FILTER" | "MCP_ACCESS_TOKEN" | "ADMIN_TOKEN" | "DATAFORSEO_USERNAME" | "DATAFORSEO_PASSWORD">> {}
}
